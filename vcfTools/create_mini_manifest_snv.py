...
df_donor_indel = df_donor.loc[df_donor['Variant.Type'] == 'SNV', ]

donor_ids = list(set(list(df_donor['ICGC.Donor'])))


merged_vcf_path_local = '/Users/lnguyen/hpc/cog_bioinf/cuppen/project_data/Luan_PCAGW/merged_vcfs/snv2'
